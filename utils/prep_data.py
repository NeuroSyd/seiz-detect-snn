...
def train_val_loo_split_fusion(ictal_X, ictal_X_other, ictal_y, interictal_X, interictal_X_other, interictal_y, val_ratio):
    '''
    ...
    for i in range(nfold):
        ...
        if i==0:
            ...
            X_other_train_interictal = np.concatenate([interictal_X_other[:i * interictal_fold_len], interictal_X_other[(i + 1) * interictal_fold_len + 1:]],axis=0)
            ...
            X_other_train_ictal = np.concatenate(ictal_X_other[:i],axis=0)
            y_train_ictal = np.concatenate(ictal_y[:i],axis=0)

            X_train_interictal = interictal_X[:i * interictal_fold_len]
            X_other_train_interictal = interictal_X_other[:i * interictal_fold_len]
        ...
        if down_spl > 1:
            ...
            X_other_train_interictal = X_other_train_interictal[::down_spl]
            y_train_interictal = y_train_interictal[::down_spl]
        elif down_spl == 1:
            X_train_interictal = X_train_interictal[:X_train_ictal.shape[0]]
            X_other_train_interictal = X_other_train_interictal[:X_other_train_ictal.shape[0]]
        ...
        X_other_train = np.concatenate((X_other_train_ictal[:int(X_other_train_ictal.shape[0]*(1-val_ratio))],X_other_train_interictal[:int(X_other_train_interictal.shape[0]*(1-val_ratio))]),axis=0)
        ...
        X_other_val = np.concatenate((X_other_train_ictal[int(X_other_train_ictal.shape[0]*(1-val_ratio)):],X_other_train_interictal[int(X_other_train_interictal.shape[0]*(1-val_ratio)):]),axis=0)
        ...
        X_val = X_val[:nb_val]
        X_other_val = X_other_val[:nb_val]
        y_val = y_val[:nb_val]
        ...
        X_other_test = np.concatenate((X_other_test_ictal, X_other_test_interictal),axis=0)
        y_test = np.concatenate((y_test_ictal, y_test_interictal),axis=0)

        # remove overlapped ictal samples in test-set
        X_test = X_test[y_test != 2]
        X_other_test = X_other_test[y_test != 2]
        y_test = y_test[y_test != 2]
        X_test = X_test[y_test != -1]
        X_other_test = X_other_test[y_test != -1]
        y_test = y_test[y_test != -1]

        print ('X_train, X_other_train, X_val, X_test',X_train.shape, X_other_train.shape, X_val.shape, X_test.shape)
        yield (X_train, X_other_train, y_train, X_val, X_other_val, y_val, X_test, X_other_test, y_test)
